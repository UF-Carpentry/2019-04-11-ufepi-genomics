...
<p id="requirements">
  ...
  <a href="#setup">below</a> and <a href="https://datacarpentry.org/genomics-workshop/setup.html">here</a>). They are also required to abide by
  {% if page.carpentry == "swc" %}
...
<p>
  To participate in a this Carpentries-inspired workshop,
      ...
      <ol>
        ...
        <li>Run the installer and follow the steps below:
          <ol>
            ...
            <li>
                Keep "Use Git from the command line and also from 3rd-party software" selected and click on "Next".
